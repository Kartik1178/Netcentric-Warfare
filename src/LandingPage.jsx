    ...
    <div className="min-h-screen w-full h-full bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 text-white">
      ...
      <header className="container mx-auto py-6 px-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          <Link to="/fake" className="text-slate-300 hover:text-white transition-colors">
            Features
          </Link>
          <Link to="/fake"   className="text-slate-300 hover:text-white transition-colors">
            How It Works
      ...
      <section className="container mx-auto px-4 py-20 md:py-32 flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 mb-10 md:mb-0">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button className="bg-blue-600 hover:bg-blue-700 text-black px-8 py-6 rounded-lg text-lg">
              Launch Simulator
            </Button>
            <Button
              variant="outline"
              className="border-slate-600 text-black hover:bg-slate-800 px-8 py-6 rounded-lg text-lg"
            >
              Watch Demo
            </Button>
          </div>
        ...
        <div className="md:w-1/2 relative">
          ...
          <div className="bg-slate-800 border border-slate-700 rounded-xl overflow-hidden shadow-2xl">
            ...
            <img
              ...
              alt="Defense Simulator Interface"
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-300 max-w-2xl mx-auto">
              Our defense simulator provides cutting-edge tools for realistic threat response planning and weapon
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <FeatureCard
              ...
              title="Interactive Weapon Deployment"
              description="Drag and drop defense systems onto tactical maps with precise positioning and rotation controls."
            />
            <FeatureCard
              icon={<Crosshair className="h-8 w-8 text-blue-400" />}
              title="Multiple Threat Scenarios"
              description="Simulate responses to aerial, naval, missile, and ground-based threats with realistic parameters."
            />
            <FeatureCard
              icon={<Radar className="h-8 w-8 text-blue-400" />}
              title="Real-time Detection Systems"
              description="Advanced radar and sensor simulations provide early warning and threat tracking capabilities."
            />
            <FeatureCard
              icon={<Shield className="h-8 w-8 text-blue-400" />}
              title="Defense Effectiveness Analysis"
              description="Comprehensive analytics on defense system performance and threat mitigation capabilities."
            />
            <FeatureCard
              icon={<Zap className="h-8 w-8 text-blue-400" />}
              title="Communication Networks"
              description="Simulated secure communications between defense units with multiple command channels."
            />
            <FeatureCard
              icon={<BarChart3 className="h-8 w-8 text-blue-400" />}
              title="Strategic Response Planning"
              description="Develop and test defense strategies against various threat vectors and scenarios."
            />
          </div>
        </div>
      </section>
      ...
      <section id="how-it-works" className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-300 max-w-2xl mx-auto">
              Our intuitive interface makes complex defense simulation accessible and engaging.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <StepCard
              number="01"
              title="Select Threat Scenario"
              description="Choose from multiple threat types including aerial, missile, naval, and ground forces."
            />
            <StepCard
              number="02"
              title="Deploy Defense Systems"
              description="Drag and drop weapons onto the tactical map to create your defense strategy."
            />
            <StepCard
              number="03"
              title="Analyze Response Effectiveness"
              description="Review detailed analytics on your defense system's performance against the selected threat."
            />
          </div>
      ...
      {/* Scenarios Section */}
      <section id="scenarios" className="bg-slate-800/50 py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Available Scenarios</h2>
            <p className="text-slate-300 max-w-2xl mx-auto">
              Test your defense strategies against a variety of realistic threat scenarios.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <ScenarioCard
              title="Aerial Threats"
              description="Defend against bomber and fighter aircraft incursions with air defense systems."
              image="/placeholder.svg?height=200&width=300"
              color="from-blue-900/50 to-blue-700/50"
            />
            <ScenarioCard
              title="Missile Defense"
              description="Counter ballistic and cruise missile attacks with multi-layered interception systems."
              image="/placeholder.svg?height=200&width=300"
              color="from-red-900/50 to-red-700/50"
            />
            <ScenarioCard
              title="Naval Incursions"
              description="Protect coastlines from surface vessels and submarine threats."
              image="/placeholder.svg?height=200&width=300"
              color="from-cyan-900/50 to-cyan-700/50"
            />
            <ScenarioCard
              title="Ground Forces"
              description="Defend against infantry and armored vehicle advances with strategic deployments."
              image="/placeholder.svg?height=200&width=300"
          ...
          <div className="bg-gradient-to-r from-blue-900 to-slate-800 rounded-2xl p-8 md:p-12 shadow-xl relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button
                  variant="outline"
                  className="border-white/20 text-black hover:bg-white/10 px-8 py-6 rounded-lg text-lg"
                >
                  Learn More
                </Button>
              </div>
...
function ScenarioCard({
  ...
  return (
    <div className="group relative overflow-hidden rounded-xl">
      <div
        className={`absolute inset-0 bg-gradient-to-t ${color} opacity-90 group-hover:opacity-100 transition-opacity`}
      >
